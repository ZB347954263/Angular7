...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        // 服务器统一请求接口路径
        , serverUrl: URL + "/api/ueditor/upload"
        ...
        , toolbars: [
            ...
            // // 'simpleupload',
			// 'insertimage', 
			// //'emotion', 'scrawl', 'insertvideo', 'music', 'attachment', 'map', 'gmap', 'insertframe', 'insertcode', 'webapp',
            // 'horizontal', '|',
    ...
    function getConfigFilePath() {debugger
